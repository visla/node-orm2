...
Driver.prototype.reconnect = function (cb, connection) {
  ...
  if (typeof connOpts == 'object') {
    // remove protocol and query as mysql2 requires exact params to be present otherwise it might show warnings or errors.
    connOpts = _.omit(connOpts, ['debug', 'protocol', 'query']);
  }
